...
toc:
  ...
  - name: Collaborative Filtering (CF) & Matrix Factorization
  - name: Content-Based Filtering (CBF)
...
<blockquote>
📊 <strong>Prefer slides?</strong> Check out the interactive presentation: <a href="https://mamood.ir/bioinformatics-recommender-systems/">Bioinformatics Recommender Systems Slides</a>
</blockquote>
